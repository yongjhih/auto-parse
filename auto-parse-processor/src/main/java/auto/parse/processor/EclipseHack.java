...
class EclipseHack {
   ...
   * has no effect.
   */
  void reorderProperties(List<AutoParseProcessor.Property> properties) {
    ...
    while (index < properties.size()) {
      ...
      List<AutoParseProcessor.Property> subList = properties.subList(index, nextIndex);
      reorderProperties(owner, subList);
      index = nextIndex;
    }
  }

  private void reorderProperties(TypeElement type, List<AutoParseProcessor.Property> properties) {
    ...
    if (allFound) {
      ...
      Comparator<AutoParseProcessor.Property> comparator = new Comparator<AutoParseProcessor.Property>() {
        @Override
