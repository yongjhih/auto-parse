...
public class CompilationErrorsTest extends TestCase {
  ...
  public void testNoWarningsFromGenerics() throws Exception {
    String testSourceCode =
        ...
        "    return new AutoParse_Baz<T, U>(t, u);\n" +
        "  }\n" +
        "}\n";
  ...
  */
  ...
  public void testExtendAutoParse() throws Exception {
    String testSourceCode =
        "package foo.bar;\n" +
        "import auto.parse.AutoParse;\n" +
        "public class Outer {\n" +
  ...
  public void testNonExistentSuperclass() throws Exception {
    // The main purpose of this test is to check that AutoParseProcessor doesn't crash the
  ...
  public void testImplementingAnnotationRequiresDefiningEquals() throws Exception {
    // Since the equals algorithm we use for AutoParse classes is incompatible with the one
    ...
    String testSourceCode =
        ...
        "    return new AutoParse_RetentionImpl(policy);\n" +
        "  }\n" +
  ...
  public void testImplementingAnnotationRequiresDefiningHashCode() throws Exception {
    // Since the hashCode algorithm we use for AutoParse classes is incompatible with the one
  ...
  private void assertCompilationResultIs(
    ...
    List<String> options = ImmutableList.of(
        ...
        "-d", tmpDir.getPath(),
        "-processor", AutoParseProcessor.class.getName(),
        "-Xlint");
